...
public class Controller {
    ...
    public Controller(View view){
        ...
        view.addAccListener(new AccListener());
        view.addNoAccListener(new NoAccListener());
    ...
    class AccListener extends MouseAdapter {
        @Override
        public void mouseClicked(MouseEvent e) {
            view.createLoginPanel(view.getContentPanel());
        }
    ...
    class NoAccListener extends MouseAdapter {
        @Override
        public void mouseClicked(MouseEvent e) {
            view.createSignUpPanel(view.getContentPanel());
        }
    }
