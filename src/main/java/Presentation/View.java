...
public class View extends JFrame{
    ...
    public final JLabel priceTransportLabel = new JLabel("");
    ...
    private final JLabel accLabel = new JLabel("Aveti deja un cont?");
    private final JLabel noAccLabel = new JLabel("Nu aveti un cont?");
    private JTextField emailTextField;
    private JPasswordField passwordTextField;
    private final JButton loginButton = new JButton("CONECTARE");
    private final JButton signButton = new JButton("INREGISTRARE");
...
//        showPopUpDialog();
    ...
    public void createLoginPanel(JPanel contentPanel) {
        ...
        noAccLabel.setForeground(Color.gray);
        noAccLabel.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));

        JPanel labelPanel = new JPanel();
        labelPanel.add(noAccLabel);

        JPanel gridPanel = new JPanel();
        gridPanel.add(new JLabel("Email:"));
        gridPanel.add(emailTextField);
        gridPanel.add(new JLabel("Parola:"));
        gridPanel.add(passwordTextField);
        gridPanel.setLayout(new GridLayout(4, 1, 0, 10));
    ...
    public void createSignUpPanel(JPanel contentPanel) {
        ...
        emailTextField = new JTextField(20);
        passwordTextField = new JPasswordField(20);
        try {phoneTextField = new JFormattedTextField(new MaskFormatter("###-###-####"));
        } catch (ParseException ignored) {}

        signButton.setFont(fo);
        signButton.setForeground(Color.white);
        signButton.setBackground(new Color(0x3c7eda));

        accLabel.setForeground(Color.gray);
        accLabel.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        ...
        JPanel btnPanel = new JPanel();
        btnPanel.add(signButton);

        JPanel gridPanel = new JPanel();
        gridPanel.add(new JLabel("Prenume:"));
        gridPanel.add(lastNameTextField);
        gridPanel.add(new JLabel("Nume:"));
        gridPanel.add(firstNameTextField);
        gridPanel.add(new JLabel("Adresa:"));
        gridPanel.add(addrTextField);
        gridPanel.add(new JLabel("Telefon:"));
        gridPanel.add(phoneTextField);
        gridPanel.add(new JLabel("Email:"));
        gridPanel.add(emailTextField);
        gridPanel.add(new JLabel("Parola:"));
        gridPanel.add(passwordTextField);
        gridPanel.setLayout(new GridLayout(12, 1, 0, 10));
        gridPanel.setPreferredSize(new Dimension(500, 400));
        ...
        signUpPanel.add(sep);
        signUpPanel.add(labelPanel);
        signUpPanel.setPreferredSize(new Dimension(500, 650));
    ...
    public void createCartPanel(JPanel contentPanel){
        ...
        costPanel.setPreferredSize(new Dimension(150, 100));
        ...
        moneyPanel.add(Box.createHorizontalStrut(100));
        moneyPanel.add(priceTransportLabel);
        moneyPanel.setBackground(Color.white);
        moneyPanel.setPreferredSize(new Dimension(100, 100));
        ...
        pricePanel.add(Box.createHorizontalStrut(150));
    ...
    public void createSellPanel(JPanel contentPanel){
        ...
        JPanel gridPanel = new JPanel();
        gridPanel.add(new JLabel("Nume produs: "));
        gridPanel.add(tName);
        gridPanel.add(new JLabel("Pret produs: "));
        gridPanel.add(tPrice);
        gridPanel.add(new JLabel("Cantitate produs: "));
        gridPanel.add(tQuantity);
        gridPanel.add(new JLabel("Stock produs: "));
        gridPanel.add(tStock);
        gridPanel.add(new JLabel("Categorie produs: "));
        gridPanel.add(productsCategories);
        gridPanel.add(new JLabel("Expirare produs: "));
        gridPanel.add(datePicker);
        gridPanel.add(new JLabel("Imagine produs: "));
        gridPanel.add(imgLabel);
        gridPanel.setLayout(new GridLayout(14, 1, 0, 10));

        JPanel sellPanel = new JPanel();
        sellPanel.add(gridPanel);
        sellPanel.add(Box.createVerticalStrut(30));
        sellPanel.add(btnPanel);
        sellPanel.setLayout(new BoxLayout(sellPanel, BoxLayout.Y_AXIS));
        sellPanel.setPreferredSize(new Dimension(500, 600));
    ...
    public void updateCostLabel(){
        ...
        totalCost = cost + transport;
        priceProductsLabel.setText(dfrmt.format(cost) + " LEI");
        priceTransportLabel.setText(dfrmt.format(transport) + " LEI");
        moneyLabel.setText(dfrmt.format(cost + transport) + " LEI");
    }
    ...
    public void addNoAccListener(MouseAdapter l){noAccLabel.addMouseListener(l);}
    public void addAccListener(MouseAdapter l){accLabel.addMouseListener(l);}
